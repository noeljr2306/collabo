    ...
    <div className="min-h-screen bg-slate-950 flex flex-col items-center justify-center p-4">
      ...
      <SignIn
        appearance={{
          elements: {
            formButtonPrimary:
              "bg-emerald-500 hover:bg-emerald-400 text-slate-950 transition-all active:scale-95",
            ...
            formFieldInput:
              "bg-slate-800 border-slate-700 text-slate-50 focus:border-emerald-500 focus:ring-emerald-500",
            footerActionLink:
